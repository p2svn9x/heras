                ...
                <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-sm-3">
                          <div class="callout callout-info">
                            ...
                            <br>
                            <strong class="h4"><?php echo $bintotal;?></strong>
                        ...
                        <div class="col-sm-3">
                          <div class="callout callout-danger">
                            <small class="text-muted">Pass vbv</small>
                            <br>
                  ...
                  <table class="table table-responsive-sm table-hover table-outline mb-0">
                    <thead class="thead-light">
                      <tr>
                        <th class="text-center">Bin number</i></th>
                    ...
                    <?php 
                     foreach ($data as $k){
                       echo "<tr><th class='text-center'>".$k['bin']."</i></th>";
                        echo "<th class='text-center'>".$k['bank']."</i></th>";
                        echo "<th class='text-center'>".$k['type']."</i></th>";
                       if ($k['ispassvbv']==1){$ispass ="Yes";} else{$ispass="No";}
                        echo "<th>".$ispass."</i></th></tr>";
                     }
